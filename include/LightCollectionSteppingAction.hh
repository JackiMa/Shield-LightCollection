...
//
//
/// \file LightCollectionSteppingAction.hh
/// \brief Definition of the LightCollectionSteppingAction class
...
{
 public:
  LightCollectionSteppingAction(LightCollectionEventAction*);
